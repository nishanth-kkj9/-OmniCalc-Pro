...
class ConverterEngine:
    ...
    def convert(value, from_unit, to_unit, category):
        ...
        base = value * ConverterEngine.CATEGORIES[category][from_unit]
        return base / ConverterEngine.CATEGORIES[category][to_unit]

    @staticmethod
    def _convert_temp(val, src, dst):
        c = (val - 32) * 5/9 if src == "F" else val - 273.15 if src == "K" else val
        if dst == "C": return c
